...
public class User {
    private String name; // User name as an String 
    private int weight; // User weight as an int 
    private int height;// persons eight in the Height class
    private String hometown; // User hometown as a string 
    private String highschool;  // User player high school as a string
    
    
    public User (String firstName, int weightInPounds, int height1, String hometownLIT, String highschoolLIT){
